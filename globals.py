...
DEFAULT_TINY_PATH_WIN11: str | bool = DEFAULT_TINY_PATH + """\\win11""" if DEFAULT_TINY_PATH else False

DEFAULT_TINY_PATH_WIM_MOUNT: str | bool = DEFAULT_TINY_PATH + """\\WimMount""" if DEFAULT_TINY_PATH else False

WIM_REL_PATH = """\\sources\\install.wim"""
ESD_REL_PATH = """\\sources\\install.esd"""

DEFAULT_TINY_PATH_WIN11_WIM: str | bool = DEFAULT_TINY_PATH_WIN11 + WIM_REL_PATH if DEFAULT_TINY_PATH else False
DEFAULT_TINY_PATH_WIN11_ESD: str | bool = DEFAULT_TINY_PATH_WIN11 + ESD_REL_PATH if DEFAULT_TINY_PATH else False
